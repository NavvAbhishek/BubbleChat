  ...
  return (
    <div className="bg-white h-[calc(100vh-64px)] text-black flex flex-col justify-center items-center text-center px-6">
      <h1 className="text-4xl font-bold mb-8">
        Welcome to{" "}
        <span className=" bg-lightYellow px-2 py-1 rounded-lg text-blue">
          Bubble Chat
        </span>
      </h1>
      ...
      <button className="bg-lightYellow text-deepBlue text-lg px-6 py-2 rounded-lg my-4 cursor-pointer font-bold">
